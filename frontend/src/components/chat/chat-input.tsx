    ...
    <div className="relative w-full min-w-0">
      <div
        className={cn(
          ...
          "bg-white dark:bg-stone-900 border-stone-200 dark:border-stone-800 shadow-warm-sm",
          "focus-within:border-amber-400 dark:focus-within:border-amber-600",
        )}
      >
        <Textarea
          ref={textareaRef}
      ...
      <div className="mt-1.5 flex items-center justify-between px-1 text-[11px] text-stone-400 dark:text-stone-500">
        <span>
          Press <kbd className="px-1 py-0.5 rounded bg-stone-100 dark:bg-stone-800 text-stone-700 dark:text-stone-300 font-mono">Enter</kbd> to send, <kbd className="px-1 py-0.5 rounded bg-stone-100 dark:bg-stone-800 text-stone-700 dark:text-stone-300 font-mono">Shift+Enter</kbd> for line break
        </span>
      </div>
    </div>
  );
