      ...
      <AnimatePresence mode="wait">
        {isLoaded && !isUploading ? (
          ...
          >
            ...
            <GlassCard variant="default" padding="default" className="border-emerald-500/50 bg-emerald-500/15 dark:bg-emerald-950/40 shadow-sm">
              <div className="flex flex-col space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="p-2.5 rounded-xl bg-emerald-500/25 text-emerald-600 dark:text-emerald-300 shrink-0">
                      <CheckCircle className="w-6 h-6" />
                    </div>
                    <div className="min-w-0">
                      <span className="text-base sm:text-lg font-extrabold tracking-tight text-emerald-700 dark:text-emerald-300 block leading-tight">
                        The RAG pipeline is ready to answer
                      </span>
                      <div className="flex items-center gap-2 text-xs text-zinc-600 dark:text-zinc-300 mt-1">
                        <Layers className="w-3.5 h-3.5 shrink-0 text-emerald-600 dark:text-emerald-400" />
                        <span className="font-bold text-zinc-900 dark:text-zinc-100 truncate">
                          {activeDocCount} PDF{activeDocCount > 1 ? "s" : ""} Loaded
                        </span>
                        <span>•</span>
                        <span className="font-medium text-emerald-700 dark:text-emerald-400">{chunksCreated} chunks indexed</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-1 shrink-0 ml-2">
                    <button
                      ...
                      className="p-1.5 rounded-lg text-zinc-600 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50 transition-colors text-xs flex items-center gap-1 font-semibold cursor-pointer border border-emerald-500/20"
                      title={showDetails ? "Hide pipeline details" : "View pipeline details"}
                    >
