  ...
  return (
    <section className="relative py-16 sm:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        >
          <Badge variant="outline" className="mb-6 px-3.5 py-1 text-xs">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold text-zinc-900 dark:text-zinc-100 tracking-tight leading-[1.1] mb-6">
            ...
            <span className="text-zinc-500 dark:text-zinc-400">Retrieval Generation</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-10">
            {[
              ...
              <span
                key={f.text}
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-zinc-100 dark:bg-zinc-800/80 text-zinc-700 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700"
              >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <Button size="lg" onClick={() => navigate("/chat")} className="w-full sm:w-auto">
